...
contract OPShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 OPSHARE
    ...
    constructor(
        ...
        address _devFund
    ) public ERC20("OPSHARE", "OPSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 OPTOMB Share for initial pools deployment
